...
### 5. 도메인 및 DNS: Cloudflare

**서비스**: Cloudflare (Domain Registrar + DNS)  
**역할**: 
- 도메인 등록 및 관리
- DNS 레코드 관리
- DDoS 보호
...
**도메인**:
- `front-wiki.com` (Cloudflare Registrar에서 구매)
- `www.front-wiki.com` (CNAME 레코드로 연결)

**DNS 설정**:
- **방식**: Cloudflare DNS 사용 (네임서버 변경 없음)
